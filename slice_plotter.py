...
if __name__ == "__main__":
    ...
    for filename in filelist:
        if filename.endswith(".stl"):
            ...
            plt.scatter(midarrayz[:,0],midarrayz[:,1], s=1, label=filename[:-4].replace('_',' '))
    ...
    for filename in filelist:
        if filename.endswith(".stl"):
            ...
            plt.scatter(midarrayz[:,1],midarrayz[:,2], s=1, label=filename[:-4].replace('_',' '))
    ...
    for filename in filelist:
        if filename.endswith(".stl"):
            ...
            plt.scatter(midarrayz[:,0],midarrayz[:,2], s=1, label=filename[:-4].replace('_',' '))
